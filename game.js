...
const scenarios = [
    {
        story: "你拿到两个 offer：大厂月薪 9K，但每天 10 点下班；创业公司月薪 7K，6 点准时走。你算了一下，大厂时薪其实更高——但你的时间还剩多少？",
        choices: [
            { text: "💪 去大厂，时薪思维，趁年轻多赚", money: 20, happy: -10, career: 15, tag: "money" },
            { text: "🌿 去创业公司，时间也是钱", money: 5, happy: 15, career: 5, tag: "life" }
        ],
